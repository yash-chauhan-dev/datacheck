...
<div class="impact-card" style="background: linear-gradient(135deg, #718096 0%, #4a5568 100%); padding: 2.5rem; border-radius: 16px; color: white; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.4);">
  ...
  <a href="/use-cases/#data-contracts-between-teams" style="display: inline-block; margin-top: 1.5rem; padding: 0.75rem 1.5rem; background: white; color: #718096; border-radius: 8px; text-decoration: none; font-weight: 600; transition: transform 0.2s; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);">See How →</a>
</div>
